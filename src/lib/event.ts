...
export const SCHEDULE: { day: string; items: ScheduleItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: '14:30', what: 'Pitches & feedback — 8 teams × 10 min (3-min pitch + 7-min Q&A), order drawn at random; a mempool block sound caps each pitch', where: 'Warden Student Center', kind: 'talk' },
      { time: '16:00', what: 'Jury deliberation (private)', where: 'Warden Student Center', kind: 'talk' },
      { time: '16:30', what: 'Awards & closing feedback (room until 18:00)', where: 'Warden Student Center', kind: 'social' },
